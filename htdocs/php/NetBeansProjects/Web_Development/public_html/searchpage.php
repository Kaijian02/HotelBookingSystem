...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="search-container" style="margin-right: 110px;">
                        <form action="searchpage.php" method="GET">
                            <input type="text" placeholder="Search rooms" value="<?php
                            if (isset($_GET['search'])) {
                                echo $_GET['search'];
                            }
                            ?>" id="searchBar" name="search" style="margin-bottom:10px" required>
        ...
        if (isset($_GET['search'])) {
            ...
            $sql = "SELECT count(id) AS total FROM room WHERE name LIKE '%$filtervalues%'";
        ...
        <section style="background-color: #f0f8ff; padding-top: 20px; padding-bottom: 20px;">
            ...
            <div class="container text-center">
                ...
                <div class="col-lg-4 col-md-4 text-center" style="margin:auto;">
                    <div class="filter__found">
                        <h6><span><?php echo $num_rows; ?></span> Rooms found</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="features-container">
                <div class="row" style="display: block;">
                    ...
                    <?php
                    if (isset($_GET['search'])) {
                        $query = "SELECT * FROM room WHERE name LIKE '%$filtervalues%'";
                                        ...
                                        <div class='responsive-div' style='background-color: #d8dfe5; border-radius: 10px; padding: 23px; '>
                                            <div class='row'>
                                                <div class='col-md-5 col-sm-12 d-flex align-items-center justify-content-center'>
                                                    <img src='img/<?php echo $row['image_path']; ?>' width='90%' height='auto' alt='alt' style='border: 3px solid white;'>
                                                </div>
                                                <div class='col-md-4 col-sm-12' style='margin-top:20px;'>
                                                    <h2>RM <?php echo $row['price']; ?> per night</h2>
