...
// Assuming you have stored the user ID in the session as 'user_id'
/*
...
<html>
    <head>
        ...
        <body >
            ...
            <!--
            <img src="img/home1.jpg" alt="Image 1" width="100%" style="margin: 0; ">               
            <p class="center-text"><a href="reservation.html" class="book">Book Now</a></p>                        
            -->
